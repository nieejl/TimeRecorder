...
namespace TimeRecorder.Server.WebAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IProjectAdapterRepo, ProjectAdapterRepo>();
            ...
            services.AddTransient<IRecordingAdapterRepo, RecordingAdapterRepo>();
